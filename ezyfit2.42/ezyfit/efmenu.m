...
% 2014/03/25: v1.82, buf fixed for Windows (C:\); new startup file
...
if ~isempty(ft)
    ...
    fprintf(fid,'%s\n\n','fprintf('' EzyFit -  <a href="matlab:docezyfit">Help</a> | <a href="matlab:web http://www.fast.u-psud.fr/ezyfit/html/ezyfit_gettingstarted.html -browser">Getting started</a> | <a href="matlab:web http://www.fast.u-psud.fr/ezyfit/demo/html/efdemo.html -browser">Discover</a> | <a href="matlab:web http://www.fast.u-psud.fr/ezyfit/html/ezyfit_uninstall.html -browser">Uninstall</a>\n\n'');');
    fclose(fid);
